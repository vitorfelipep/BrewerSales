...
@AtributosConfirmacao(atributo = "senha", atributoDeConfirmacao="confirmacaoSenha", message = "Confirmação da senha não confere")
@Entity  
@Table(name = "usuario")
@DynamicUpdate
public class Usuario implements Serializable {
	...
	@NotBlank(message = "Nome é obirgatório!")
	private String nome;
